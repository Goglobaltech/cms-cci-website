...
export default function UpdateCosmetics() {
  ...
  const [updateProduct, { data: d, error }] = useMutation(
    UPDATE_PRODUCTS,
    {
  ...
  // console.log(editData?.imageSlideLeft, "::: editData?.imageSlideLeft");
  const {
    errors,
    touched,
    handleSubmit,
        ...
        <Stack direction="column" justifyContent="center">
          <Typography>
            ...
            <span
              ...
              onClick={() => navigate("/cosmetics/updatecosmetics")}
            >
              Create cosmetics
            </span>
          </Typography>
